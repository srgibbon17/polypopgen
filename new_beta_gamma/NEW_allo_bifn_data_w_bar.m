function [neutral_data, selected_data, unstable_data] = NEW_allo_bifn_data_w_bar(s_val_range, mu_val, nu_val, h1_val, h2_val, h3_val, beta_val, gamma_val)
...
function [diff_eqn_eval] = allo_diff_eq_eval(diff_eqn, mu, mu_val, nu, nu_val, h1, h1_val, h2, h2_val, h3, h3_val, beta, beta_val, gamma, gamma_val)
    ...
    diff_eqn_eval = subs(diff_eqn_eval, beta, beta);
    diff_eqn_eval = subs(diff_eqn_eval, gamma, gamma);
