function [neutral_data, selected_data, unstable_data] = new_allo_bifn(s_val_range, mu_val, nu_val, h1_val, h2_val, h3_val, beta_val, gamma_val)
...
elseif gamma_val > 1
    ...
    return;
elseif gamma_val < -(min(beta_val, 1-beta_val)/max(beta_val, 1-beta_val)) - .02
