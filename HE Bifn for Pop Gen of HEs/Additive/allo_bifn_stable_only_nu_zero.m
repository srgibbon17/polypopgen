function [stable_data, fixed_q_data, fixed_sga_data, fixed_sgb_data] = allo_bifn_stable_only_nu_zero(s_val_range, mu_val, nu_val, h1_val, h2_val, h3_val, beta_val, gamma_val)
...
sel_g00 = g00^2*w0 + (.5+(beta)/16)*2*g01*g00*w1 +   (.5+(beta)/16)*2*g10*g00*w1 +     ((2*beta + beta*(1-beta)*(1-gamma))/8)*g01^2*w2 +     ((2*beta + beta*(1-beta)*(1-gamma))/8)*g10^2*w2 + (.25-(beta*(1-beta)*(1-gamma))/16)*(2*g00*g11+2*g01*g10)*w2 +      ((beta)/16)*2*g01*g11*w3 +      ((beta)/16)*2*g10*g11*w3;
sel_g10 =             ((3*beta)/16)*2*g01*g00*w1 + (.5-(5*beta)/16)*2*g10*g00*w1 + ((beta + (1-gamma)*beta^2 + beta*gamma)/8)*g01^2*w2 +   (1-(6*beta + beta*(1-beta)*(1-gamma))/8)*g10^2*w2 + (.25+(beta*(1-beta)*(1-gamma))/16)*(2*g00*g11+2*g01*g10)*w2 +    ((3*beta)/16)*2*g01*g11*w3 + (.5-(5*beta)/16)*2*g10*g11*w3;
sel_g01 =          (.5-(5*beta)/16)*2*g01*g00*w1 +    ((3*beta)/16)*2*g10*g00*w1 +   (1-(6*beta + beta*(1-beta)*(1-gamma))/8)*g01^2*w2 + ((beta + (1-gamma)*beta^2 + beta*gamma)/8)*g10^2*w2 + (.25+(beta*(1-beta)*(1-gamma))/16)*(2*g00*g11+2*g01*g10)*w2 + (.5-(5*beta)/16)*2*g01*g11*w3 +    ((3*beta)/16)*2*g10*g11*w3;
sel_g11 =               ((beta)/16)*2*g01*g00*w1 +      ((beta)/16)*2*g10*g00*w1 +     ((2*beta + beta*(1-beta)*(1-gamma))/8)*g01^2*w2 +     ((2*beta + beta*(1-beta)*(1-gamma))/8)*g10^2*w2 + (.25-(beta*(1-beta)*(1-gamma))/16)*(2*g00*g11+2*g01*g10)*w2 +   (.5+(beta)/16)*2*g01*g11*w3 +   (.5+(beta)/16)*2*g10*g11*w3 + g11^2*w4;
...
stable_q = stable_g11 + (1/2)*stable_g01 + (1/2)*stable_g10;
...
fixed_q_q = fixed_q_g11 + (1/2)*fixed_q_g01 + (1/2)*fixed_q_g10;
...
fixed_sga_q = fixed_sga_g11 + (1/2)*fixed_sga_g01 + (1/2)*fixed_sga_g10;
...
fixed_sgb_q = fixed_sgb_g11 + (1/2)*fixed_sgb_g01 + (1/2)*fixed_sgb_g10;
