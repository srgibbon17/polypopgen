...
s_init_val = 1.75e-4; % starting s value
...
[g0_value, g1_value] = numeric_solver(mut_eqn_set(1), mut_eqn_set(2), mu, mu_val, nu, nu_val, s, s_init_val, h1, h1_val, h2, h2_val, h3, h3_val, a, a_val, g0, g1);
...
for i = 1:length(g0_value)
    ...
    for j = 1:length(jacobian_eval)
        for k = 1:length(jacobian_eval)
           jacobian_eval(j, k) = pd_evaluation(jacobian_1(j, k), mu, mu_val, nu, nu_val, s, s_init_val, h1, h1_val, h2, h2_val, h3, h3_val, a, a_val, g0, g0_value(i), g1, g1_value(i)); 
        end
    end
