...
for h = 1:length(s_val_range)
    ...
    for i = 1:length(g0_value)
        ...
        subplot(2, 3, h+3)
        if length(g0_value) == 1  
            rm = quiver(g0_coordinates, g1_coordinates, g0_rm_field, g1_rm_field, 0, 'Color', 'k');
            hold on
            mut = quiver(g0_coordinates, g1_coordinates, g0_mut_field-g0_rm_field, g1_mut_field-g1_rm_field, 0, 'Color', "#0072BD");
            sel = quiver(g0_coordinates, g1_coordinates, g0_sel_field-g0_rm_field, g1_sel_field-g1_rm_field, 0, 'Color', "#D95319");
            hold off
        ...
        elseif i == 3
            rm = quiver(g0_coordinates, g1_coordinates, g0_rm_field, g1_rm_field, 'Color', 'k');
            hold on
            mut = quiver(g0_coordinates, g1_coordinates, g0_mut_field-g0_rm_field, g1_mut_field-g1_rm_field, 0, 'Color', "#0072BD");
            sel = quiver(g0_coordinates, g1_coordinates, g0_sel_field-g0_rm_field, g1_sel_field-g1_rm_field, 0, 'Color', "#D95319");
            hold off
