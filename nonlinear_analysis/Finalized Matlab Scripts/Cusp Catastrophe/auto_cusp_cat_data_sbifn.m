function [neutral_q, selected_q, unstable_q, neutral_avg_fitness, selected_avg_fitness, unstable_avg_fitness, s_coord, k_coord] = auto_cusp_cat_data_sbifn(s_val_range, mu_val, nu_val, k_val_range, a_val)
...
% finding initial guesses [g0, g1, s] to pass to vpasolve to determine the
% bifn points
