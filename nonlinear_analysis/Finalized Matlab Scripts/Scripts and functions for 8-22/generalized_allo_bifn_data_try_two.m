function [neutral_q, neutral_s, neutral_avg_fitness, selected_q, selected_s, selected_avg_fitness, unstable_q, unstable_s, unstable_avg_fitness] = generalized_allo_bifn_data_try_two(s_val_range, mu_val, nu_val, h1_val, h2_val, h3_val, beta_val, gamma_val)
...
for i = 1:length(s_val_range)
   ...
   %solves for the fixed points of the system
    [g00_root_vals, g01_root_vals, g11_root_vals] = generalized_allo_root_solns(mut_eqn_set(1), mut_eqn_set(2), mut_eqn_set(4), mu, mu_val, nu, nu_val, s, s_val_range(i), h1, h1_val, h2, h2_val, h3, h3_val, beta, beta_val, gamma, gamma_val, g00, g01, g11);
        
    %evaluating the jacobian and stability of each fixed point
    [fixed_pt_stabilities] = generalized_allo_linear_stability_analysis(jac_matrix, mu, mu_val, nu, nu_val, s, s_val_range(i), h1, h1_val, h2, h2_val, h3, h3_val, beta, beta_val, gamma, gamma_val, g00, g00_root_vals, g01, g01_root_vals, g11, g11_root_vals);
...
selected_avg_fitness = zeros(1, length(selected_s));
