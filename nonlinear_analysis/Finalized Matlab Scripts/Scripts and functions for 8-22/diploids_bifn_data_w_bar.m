function [neutral_stable_q, neutral_stable_s, neutral_avg_fitness, selected_stable_q, selected_stable_s, selected_avg_fitness, unstable_q, unstable_s, unstable_avg_fitness] = diploids_bifn_data_w_bar(s_val_range, mu_val, nu_val, h_val)
...
neutral_genotypes = [neutral_stable_g0.^2; 2*neutral_stable_g0.*(1-neutral_stable_g0); (1-neutral_stable_g0).^2];
selected_genotypes = [selected_stable_g0.^2; 2*selected_stable_g0.*(1-selected_stable_g0); (1-selected_stable_g0).^2];
unstable_genotypes = [unstable_g0.^2; 2*unstable_g0.*(1-unstable_g0); (1-unstable_g0).^2];

neutral_abs_fitness = [ones(1, length(neutral_stable_s)); ones(1, length(neutral_stable_s)) - h_val*neutral_stable_s; ones(1, length(neutral_stable_s)) - neutral_stable_s];
selected_abs_fitness = [ones(1, length(selected_stable_s)); ones(1, length(selected_stable_s)) - h_val*selected_stable_s; ones(1, length(selected_stable_s)) - selected_stable_s];
