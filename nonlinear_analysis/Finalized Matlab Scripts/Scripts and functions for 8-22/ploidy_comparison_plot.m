function ploidy_comparison_plot(s_val_range, mu_val, nu_val, a_val, h_val, h1_val, h2_val, h3_val, grid_row, grid_col, grid_pos)
    ...
    if isempty(diploids_q3) == 1 && isempty(autos_q3) == 1 && isempty(HE0_q3) == 1 
        ...
        plot(HE0_s_values, HE0_q_values, 'Color', [0 0.4470 0.7410], 'LineWidth', 1)
        hold on
        plot(autos_s_values, autos_q_values, 'Color', [0.8500 0.3250 0.0980], 'LineWidth', 1)
        plot(diploids_s_values, diploids_q_values, 'Color', 'k', 'LineWidth', 1)
    ...
    elseif isempty(diploids_q3) == 1 && isempty(autos_q3) == 0 && isempty(HE0_q3) == 0 
        ...
        plot(diploids_s_values, diploids_q_values, 'Color', 'k', 'LineWidth', 1)
        hold on
        plot(HE0_s1, HE0_q1, 'Color', [0 0.4470 0.7410], 'LineWidth', 1)
        plot(HE0_s2, HE0_q2, 'Color', [0 0.4470 0.7410], 'LineWidth', 1)
        plot(HE0_s3, HE0_q3, 'Color', [0 0.4470 0.7410], 'LineStyle','--', 'LineWidth', 1)

        plot(autos_s1, autos_q1, 'Color', [0.8500 0.3250 0.0980], 'LineWidth', 1)
        plot(autos_s2, autos_q2, 'Color', [0.8500 0.3250 0.0980], 'LineWidth', 1)
        plot(autos_s3, autos_q3, 'Color', [0.8500 0.3250 0.0980], 'LineStyle','--', 'LineWidth', 1)
        ...
        plot(diploids_s1, diploids_q1, 'Color','k', 'LineWidth', 1)
        plot(diploids_s2, diploids_q2, 'Color','k', 'LineWidth', 1)
        plot(diploids_s3, diploids_q3, 'Color','k', 'LineStyle','--', 'LineWidth', 1)
