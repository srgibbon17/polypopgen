...
s_val = [1e-8, 2.5e-4, .3, -1e-8, -2.5e-5, -.3]; % starting s value
...
for h = 1:length(s_val)
    ...
    if h1_val == 1 && h2_val == 1 && h3_val == 1
        sgtitle('Autos: Nullclines for Dominant Allele', 'FontSize', 16)
    elseif h1_val == .25 && h2_val == .5 && h3_val == .75
        sgtitle('Autos: Nullclines for Additive Allele', 'FontSize', 16)
    elseif h1_val == 0 && h2_val == 0 && h3_val == 0
        sgtitle('Autos: Nullclines for Recessive Allele', 'FontSize', 16)
    else
        sgtitle('Autos: Nullclines for Non-Additive Allele', 'FontSize', 16)
    end
