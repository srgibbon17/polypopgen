function [t, y] = solve_ode_system()
    ...
    % Solve the ODE system using ode23tb without Jacobian
    options = odeset();
    [t, y] = ode23tb(@(t, y) odefunc(t, y, s_val, mu_val, nu_val, a_val, h1_val, h2_val, h3_val), tspan, [g0_init, g1_init], options);
