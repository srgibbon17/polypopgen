...
eqn1 = Eq(g00**2+Rational(9, 8)*g00*g01+Rational(9, 8)*g00*g10+Rational(1, 4)*g01**2+Rational(1, 4)*g10**2+Rational(1, 2)*g01*g10+Rational(1, 2)*g00*g11+Rational(1, 8)*g01*g11+Rational(1, 8)*g10*g11, g00)
eqn2 = Eq(Rational(3, 8)*g00*g01+Rational(3, 8)*g00*g10+Rational(1, 4)*g01**2+Rational(1, 4)*g10**2+Rational(1, 2)*g01*g10+Rational(1, 2)*g00*g11+Rational(3, 8)*g01*g11+Rational(3, 8)*g10*g11, g10)
eqn3 = Eq(Rational(3, 8)*g00*g01+Rational(3, 8)*g00*g10+Rational(1, 4)*g01**2+Rational(1, 4)*g10**2+Rational(1, 2)*g01*g10+Rational(1, 2)*g00*g11+Rational(3, 8)*g01*g11+Rational(3, 8)*g10*g11, g01)
eqn4 = Eq(Rational(1, 8)*g00*g01+Rational(1, 8)*g00*g10+Rational(1, 4)*g01**2+Rational(1, 4)*g10**2+Rational(1, 2)*g01*g10+Rational(1, 2)*g00*g11+Rational(9, 8)*g01*g11+Rational(9, 8)*g10*g11+g11**2, g11)
...
print(delineated_genotype_soln_set)