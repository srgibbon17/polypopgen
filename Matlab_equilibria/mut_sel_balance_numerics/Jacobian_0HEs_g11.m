...
s_init_val = 9.4815e-6; % starting s value
...
[g00_value, g01_value, g11_value] = numeric_solver(mut_eqn_set(1), mut_eqn_set(2), mut_eqn_set(4), mu, mu_val, s, s_init_val, h1, h1_val, h2, h2_val, h3, h3_val, g00, g01, g11);
...
for i = 1:length(g00_value)
    ...
    for j = 1:length(jacobian_1)
        for k = 1:length(jacobian_1)
            jacobian_eval(j, k) = pd_evaluation(jacobian_1(j, k), mu, mu_val, s, s_init_val, h1, h1_val, h2, h2_val, h3, h3_val, g00, g00_value(i), g01, g01_value(i), g11, g11_value(i));
        end
    end
...
function [g00_value, g01_value, g11_value] = numeric_solver(mut_g00_eqn, mut_g01_eqn, mut_g11_eqn, mu, mut_value, s, sel_value, h1, h1_value, h2, h2_value, h3, h3_value, g00, g01, g11)
    ...
    [g00_value, g01_value, g11_value] = vpasolve([g00_eqn, g01_eqn, g11_eqn], [g00, g01, g11]);

end

%function which acts as a partial derivative evaluation tool 
%used to evaluate the jacobian at each entry
function [pd_value] = pd_evaluation(jacobian_entry, mu, mu_value, s, s_value, h1, h1_value, h2, h2_value, h3, h3_value, g00, g00_stable_value, g01, g01_stable_value, g11, g11_stable_value)
    ...
    pd_value = subs(pd_value, g11, g11_stable_value);
