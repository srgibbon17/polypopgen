fig_1_6 = openfig("Autos fixed s a1_6.fig", 'invisible');
...
fig_1_12 = openfig("Autos fixed s a1_12.fig", 'invisible');
...
fig_0 = openfig("Autos fixed s a0.fig", 'invisible');
...
title('Change in q across alpha (fixed s)')
