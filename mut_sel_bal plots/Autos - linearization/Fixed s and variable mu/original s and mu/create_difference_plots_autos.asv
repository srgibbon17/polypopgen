...
alphahat_1 = data_1.Coefficients.Estimate(1);
betahat_1 = data_1.Coefficients.Estimate(2);

data_2 = fitlm(log10(x_8_48), log10(delta_2));
alphahat_2 = data_2.Coefficients.Estimate(1);
betahat_2 = data_2.Coefficients.Estimate(2);

data_3 = fitlm(log10(x_8_48), log10(delta_3));
alphahat_3 = data_3.Coefficients.Estimate(1);
betahat_3 = data_3.Coefficients.Estimate(2);

data_4 = fitlm(log10(x_8_48), log10(delta_4));
alphahat_4 = data_4.Coefficients.Estimate(1);
betahat_4 = data_4.Coefficients.Estimate(2);

data_5 = fitlm(log10(x_8_48), log10(delta_5));
alphahat_5 = data_5.Coefficients.Estimate(1);
betahat_5 = data_5.Coefficients.Estimate(2);

data_6 = fitlm(log10(x_8_48), log10(delta_6));
alphahat_6 = data_6.Coefficients.Estimate(1);
betahat_6 = data_6.Coefficients.Estimate(2);

data_7 = fitlm(log10(x_8_48), log10(delta_7));
alphahat_7 = data_7.Coefficients.Estimate(1);
betahat_7 = data_7.Coefficients.Estimate(2);

data_8 = fitlm(log10(x_8_48), log10(delta_8));
alphahat_8 = data_8.Coefficients.Estimate(1);
betahat_8 = data_8.Coefficients.Estimate(2);

intercepts = [alphahat_1, alphahat_2, alphahat_3, alphahat_4, alphahat_5, alphahat_6, alphahat_7, alphahat_8];
slopes = [betahat_1, betahat_2, betahat_3, betahat_4, betahat_5, betahat_6, betahat_7, betahat_8];
alpha_values = 1/48:1/48:8/48;

disp(' ')
disp('LM for Intercepts')
disp(' ')
...
disp('LM for Slopes')
disp(' ')
fitlm(alpha_values, slopes)

figure
scatter3(alpha_values, intercepts, slopes)
